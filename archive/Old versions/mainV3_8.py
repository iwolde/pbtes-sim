from coreV3_8 import Solver, Reporting 
import pandas as pd
import numpy as np

tes_params = {
    'Initial temperature': 445, #C
    'Tank lenght': 4, # m
...
solver.tes_params['Initial temperature'] = 440
...
Ps = [1]#np.linspace(5,70,3)
TES_lengths = np.linspace(4,16,7)
