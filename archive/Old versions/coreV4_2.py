...
class SolarThermalSystem:
    ...
    def create_network1(self):
        ...
        self.control_valve = tpc.Valve(label='Valve')
        ...
        self.conn_07 = tpcn.Connection(
            self.pump, 'out1',
            self.control_valve, 'in1',
            label='07_CP_CV'
            )
        
        self.conn_09 = tpcn.Connection(
            self.control_valve, 'out1',
            self.merge2, 'in1',
            label='09_CV_MG2'
            )
        ...
        self.conn_01.set_attr(T0=500, h0=700, m0=5, p0=50)
        self.conn_02.set_attr(T0=500, h0=700, m0=5, p0=50)
        self.conn_04.set_attr(T0=500, h0=700, m0=5, p0=50)
        self.conn_05.set_attr(T0=500, h0=700, m0=5, p0=50)
        self.conn_06.set_attr(T0=500, h0=700, m0=5, p0=50)
        self.conn_07.set_attr(T0=500, h0=700, m0=5, p0=50)
        self.conn_09.set_attr(T0=500, h0=700, m0=5, p0=50)
        self.conn_10.set_attr(T0=500, h0=700, m0=5, p0=50)
        self.conn_11.set_attr(T0=500, h0=700, m0=5, p0=50)
        self.conn_12.set_attr(T0=500, m0=1, p0=50)
        self.conn_13.set_attr(T0=500, m0=1, p0=50)
        self.conn_16.set_attr(T0=500, m0=1, p0=50)
        self.conn_17.set_attr(T0=500, m0=5, p0=50)
        self.conn_18.set_attr(T0=500, m0=5, p0=50)
        ...
        #
        self.charge_tes_hx.set_attr(pr1=0.99, pr2=0.99,# ttd_min=10, #eff_max=0.95,# kA=2.76e+03,
                                   design=['pr1','pr2','ttd_min'], offdesign=['zeta1','zeta2','kA_char']#,'Q'],
                                   #offdesign=['kA']
                                   )
    ...
    def set_operation_mode(self, TESmode='4', 
        ...
        if TESmode == '1':
            ...
            #self.conn_13.set_attr(T=TES_target)#, m=tpcn.Ref(self.conn_04, 0.3, 0))
            #self.conn_13.set_attr(m=tpcn.Ref(self.conn_04, 0.3, 0))
            self.conn_13.set_attr(T=tpcn.Ref(self.conn_09, 1.0, 0.0), m=tpcn.Ref(self.conn_04, 0.3, 0))
            self.conn_18.set_attr(T=TES_bot+40, p=tpcn.Ref(self.conn_16, 1.01, 0.0))

            if mode == 'offdesign':
                pass
                #self.conn_13.set_attr(T=tpcn.Ref(self.conn_09, 1, 0), m=None)
                #self.conn_13.set_attr(T=None, m=None)
                #self.conn_13.set_attr(m=None)
                #self.conn_18.set_attr(T=None)
...
class Solver:
    ...
    def iteration_check(self, TESmode, system):
        if TESmode == '1':
            T_tes_out = system.conn_16.T.val
            ...
            T_tes_out = system.conn_19.T.val
    ...
    def _iterate_tes_coupling(self, system,
        ...
        if TESmode in ['1', '6']:
            ...
            system.conn_19.set_attr(T=T_in_top)
        ...
        for iteration in range(max_iter):
            ...
            if TESmode in ['1', '6']:
                ...
                T_tes_in = system.conn_21.T.val
                m_tes_in = system.conn_21.m.val_SI
            ...
            if TESmode in ['1', '6']:
                ...
                system.conn_19.set_attr(T=T_tes_out)
