...
class SolarThermalSystem:
    ...
    def set_operation_mode(self, TESmode='4', 
        ...
        if TESmode == '1':
            ...
            self.conn_11.set_attr(T=TES_target, m=tpcn.Ref(self.conn_3, r_m_tes*0.5, 0))
            self.conn_16.set_attr(m=tpcn.Ref(self.conn_11, 4, 0))
            ...
            self.conn_18.set_attr(m=tpcn.Ref(self.conn_5, 3.5, 0))
...
class Solver:
    ...
    def compute_performance_metrics(self):
        ...
        print(f"Total pumpressor Energy:      {pump_energy_MWh:6.2f} MWh")
        if spf is not None:
