...
class ThermalEnergyStorage:
    ...
    def air_params(self):
        ...
        self.rho_f = cp.PropsSI('D', 'T', Tav, 'P', self.HTF_P, 'air')
        self.cp_f = cp.PropsSI('C', 'T', Tav, 'P', self.HTF_P, 'air')
        self.k_f = cp.PropsSI('L', 'T', Tav, 'P', self.HTF_P, 'air')
        self.mu_f = cp.PropsSI('V', 'T', Tav, 'P', self.HTF_P, 'air')
        
        self.rho_out = cp.PropsSI('D', 'T', self.tout+273.15, 'P', self.HTF_P, 'air')
    ...
    def calc_heat_loss(self, profile, dt, T_amb):
        ...
        for i, T in enumerate(profile):
            ...
            T_K = T + 273.15
            fluid_density = cp.PropsSI('D', 'T', T_K, 'P', self.HTF_P, 'Air')  # kg/m³
            fluid_cp = cp.PropsSI('C', 'T', T_K, 'P', self.HTF_P, 'Air')         # J/kg·K
...
class SolarThermalSystem:
    ...
    def create_network1(self):
        ...
        self.conn_1.set_attr(T0=500, h0=700, m0=5)
        self.conn_2.set_attr(T0=500, h0=700, m0=5)
        self.conn_3.set_attr(T0=500, h0=700, m0=5)
        self.conn_5.set_attr(T0=500, h0=700, m0=5)
        self.conn_6.set_attr(T0=500, h0=700, m0=5)
        self.conn_7.set_attr(T0=500, h0=700, m0=5)
        self.conn_9.set_attr(T0=500, h0=700, m0=5)
        self.conn_10.set_attr(T0=500, h0=700, m0=5)
        self.conn_11.set_attr(T0=500, h0=700, m0=5)
        self.conn_16.set_attr(T0=500, m0=5)
        self.conn_17.set_attr(T0=500, m0=5)
        ...
        self.conn_7.set_attr(T=self.conexion_params['7_T'],
                             p=self.conexion_params['7_p'], 
                             fluid=self.conexion_params['7_f'])
        
        self.process_hx.set_attr(pr=self.component_params['PR_pr'], 
                                 Q=self.component_params['PR_Q'])

        # TES HTF
        self.conn_16.set_attr(p=self.conexion_params['16_p'], 
                              fluid=self.conexion_params['16_f'])
    ...
    def create_network2(self):
        ...
        self.conn_3.set_attr(T0=500, h0=700)
    ...
    def create_network3(self):
        ...
        self.conn_5.set_attr(T0=600, m0=1, h0=700)
        self.conn_6.set_attr(T0=600)
        self.conn_7.set_attr(T0=600)
        self.conn_12.set_attr(T0=600)
        self.conn_13.set_attr(T0=600, h0=700)
        self.conn_18.set_attr(T0=600, m0=1)
        self.conn_19.set_attr(T0=600)
        ...
        # TES HTF
        self.conn_18.set_attr(p=self.conexion_params['18_p'], 
                              fluid=self.conexion_params['18_f'])
    ...
    def create_network4(self):
        ...
        self.conn_5.set_attr(T0=600)
        self.conn_6.set_attr(T0=600, h0=700)
        self.conn_7.set_attr(T0=600, h0=700)
        self.conn_12.set_attr(T0=600, h0=700)
    ...
    def create_network6(self):
        ...
        self.conn_2.set_attr(T0=500, h0=700)
        self.conn_3.set_attr(T0=500, h0=700)
        self.conn_4.set_attr(T0=500, h0=700)
        self.conn_5.set_attr(T0=500, h0=700)
        self.conn_6.set_attr(T0=500, h0=700)
        self.conn_7.set_attr(T0=500, h0=700)
        self.conn_11.set_attr(T0=500, h0=700)
        self.conn_16.set_attr(T0=500)
        self.conn_17.set_attr(T0=500)
        ...
        self.conn_3.set_attr(p=self.conexion_params['7_p'], 
                             fluid=self.conexion_params['7_f'],
                             T0 = 450
                             )
    ...
    def set_operation_mode(self, TESmode='4', 
        ...
        if TESmode == '1':
            ...
            if TES_top >= self.conexion_params['7_T']:
                TES_target = self.conexion_params['7_T'] + 20
            else:
                TES_target = self.conexion_params['7_T']
            self.conn_11.set_attr(T=TES_target, m=None)
            self.conn_16.set_attr(m=tpcn.Ref(self.conn_11, 1.5, 0))
            
            self.preheater_hx.set_attr(Q=0)
            self.charge_tes_hx.set_attr(Q=None, pr1=None, pr2=0.99)
        elif TESmode == '2':
            ...
            TES_top = profile[-1]
            if TES_top - 10 > self.conexion_params['7_T'] + 5: 
                TES_target = TES_top-10 
            else: 
                TES_target = self.conexion_params['7_T'] + 15
            ...
            self.conn_16.set_attr(m=tpcn.Ref(self.conn_5, 1, 0))
            ...
            self.tes.set_state('charge')
            self.conn_3.set_attr(T=520)
            self.charge_tes_hx.set_attr(Q=None, pr1=0.99, pr2=0.99)
            self.conn_16.set_attr(m=tpcn.Ref(self.conn_11, 2, 0))
            self.conn_11.set_attr(T=self.conexion_params['7_T'])
...
class Solver:
    ...
    def get_mode(self, irr, TES_profile, prev_TES_lay):
        ...
        if 410 > np.average(TES_profile):
            ...
            if irr > 500:
                ...
                return '4'
        if irr > 800:
            if self.solar_system.conexion_params['7_T'] > TES_top - 10:
                return '1'
            else: 
                return '2'
        elif irr > 500:
            ...
            if self.solar_system.conexion_params['7_T'] > TES_bot - 15:
    ...
    def initialize_modes(self):
        ...
        # Mode 2
        self.irr = 1000
        self.tes_params['Initial temperature'] = 550
        self.solar_system = SolarThermalSystem(rows=1, 
                                    tes_params=self.tes_params,
                                    component_params = self.component_params,
                                    conexion_params = self.conexion_params,
        ...
        # Mode 6
        self.irr = 1000
        self.tes_params['Initial temperature'] = 300
        self.solar_system = SolarThermalSystem(rows=1, 
                                    tes_params=self.tes_params,
                                    component_params = self.component_params,
                                    conexion_params = self.conexion_params,
    ...
    def _iterate_tes_coupling(self, system,
        ...
        for iteration in range(max_iter):
            ...
            #self.solar_system.network.print_results()
            if TESmode in ['1', '6']:
                T_tes_in = system.conn_17.T.val
                m_tes_in = system.conn_17.m.val_SI
            elif TESmode in ['5']:
                T_tes_in = T_in_bot
            ...
            if TESmode in ['1', '5', '6']:
                system.conn_16.set_attr(T=T_tes_out)
                self.TES_lay = 'Charge'
            elif TESmode == '3':
                system.conn_18.set_attr(T=T_tes_out)
            ...
            if status == 'converged':
                ...
                self.TES_profiles.append(old_profile)
                #print(TESmode)
                #print(self.solar_system.network.print_results())
                break
    ...
    def solve_network_steady(self, mode='design', TESmode='2'):
        ...
        #self.TES_lay = 'Charge'
        TESmode = self.get_mode(self.irr, self.solar_system.tes.profile, self.TES_lay)
        print(f'TES mode {TESmode}')
        design_path = f'base_design_{TESmode}'
        self.solar_system.set_operation_mode(TESmode=TESmode, 
    ...
    def run_quasi_steady_simulation(self, days_to_simulate = 10,
        ...
        for idx, row in tqdm(data_frame.iterrows(), total=len(data_frame), desc="Simulating"):
            ...
            if self.current_mode in ['1','2','5']:
                Q_ptc_kJ   = self.solar_system.ptc_field.Q.val * 3600.0
                pump_power = self.solar_system.pump.P.val 
            elif self.current_mode in ['3','4']:
                Q_ptc_kJ   = 0
                pump_power = self.solar_system.pump2.P.val 
            else:
                Q_ptc_kJ   = self.solar_system.ptc_field.Q.val * 3600.0
