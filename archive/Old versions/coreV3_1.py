...
class SolarThermalSystem:
    ...
    def set_operation_mode(self, TESmode='4'):
        ...
        if TESmode == '1':
            ...
            self.charge_tes_hx.set_attr(Q=-10000, pr1=None, pr2=0.99, eff_max=None)
            #self.discharge_tes_hx.set_attr(Q=None, pr1=None, pr2=0.99, eff_max=0.5)
            
            self.conn_15.set_attr(m=15)
            ...
            self.conn_4.set_attr(T=self.conexion_params['T_set_tes'], m=None)
...
class Solver:
    ...
    def get_mode(self, irr, TES_Tout):
        if irr > 800:
            ...
            if self.solar_system.conexion_params['6_T'] > TES_Tout:
                return '4'
            else:
                return '3'
    ...
    def _iterate_tes_coupling(self, system,
        ...
        if TESmode == '1':
            ...
            #if system.conexion_params['6_T'] > T_in_bot:
                # print('Using mode 4')
    ...
    def run_quasi_steady_simulation(self, data_frame, time_col='time',
                                    E_col='dni', Tamb_col='Tamb'):
        """
