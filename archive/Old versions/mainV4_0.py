from coreV4_0 import Solver, Reporting 
import pandas as pd
import numpy as np

HTF = 'CO2'#'INCOMP::NaK'#'Water''CO2'
HTF_TES = 'Air'

tes_params = {
    'HTF': HTF_TES, 
    'Initial temperature': 420, #C
    'Tank lenght': 10, # m
...
solver = Solver(
    ...
    HTF=HTF,
    system_mode= 'Full')
solver.init_steady(irr=800, mode='design')
...
solver = Solver(
    ...
    HTF=HTF,
    system_mode= 'Full')
solver.init_steady(irr=800, mode='offdesign')
