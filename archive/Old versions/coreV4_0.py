...
class SolarThermalSystem:
    ...
    def create_network1(self):
        ...
        self.conn_4.set_attr(T0=500, h0=700, m0=5)
        ...
        self.conn_14.set_attr(T0=500, m0=1)
        self.conn_15.set_attr(T0=500, m0=1)
        self.conn_16.set_attr(T0=500, m0=1)
        self.conn_20.set_attr(T0=500, m0=5)
        ...
        #self.charge_tes_hx.set_attr(zeta1=2, zeta2=5, kA=2.76e+03,
        #                            )
    ...
    def set_operation_mode(self, TESmode='4', 
        ...
        #     self.conn_11.set_attr(T=TES_target)#, m=tpcn.Ref(self.conn_2, 0.1, 0))
        #     self.conn_16.set_attr(T=TES_bot+20, p=tpcn.Ref(self.conn_14, 1.01, 0))
        #     if mode == 'offdesign':
        #         #pass
        #         self.conn_11.set_attr(T=None)
        #         #self.conn_11.set_attr(T=None)
                
        #         #self.conn_16.set_attr(T=TES_target + 30)
        #         #self.conn_20.set_attr(m=tpcn.Ref(self.conn_16, 0.5, 0))
        #         #self.conn_16.set_attr(T=None)
        #         #self.conn_16.set_attr(T=tpcn.Ref(self.conn_20, 1, +15))
        ...
        if TESmode == '1':
            ...
            self.conn_11.set_attr(T=TES_target)#, m=tpcn.Ref(self.conn_2, 0.1, 0))
            #self.conn_11.set_attr(p=tpcn.Ref(self.conn_7, 1.0, 0.0))
            self.conn_16.set_attr(T=TES_bot+20, p=tpcn.Ref(self.conn_14, 1.01, 0.0))


            if mode == 'offdesign':
                #pass
                self.conn_11.set_attr(T=None)
                #self.charge_tes_hx.set_attr(Q=-1.30e+05)
...
class Solver:
    ...
    def get_mode(self, irr, TES_profile, prev_TES_lay):
        ...
        if irr > 750:
            ...
            if TES_top - 10 > self.solar_system.conexion_params['6_T']:
                return '3'
