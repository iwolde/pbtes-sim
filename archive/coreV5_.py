...
class Solver:
    ...
    def get_mode(self, irr, TES_profile, prev_TES_lay):
        ...
        if self.prev_TESmode == '5' and 400 > TES_bot and irr < 600:
            return '5'
        elif self.prev_TESmode == '6' and 480 > TES_bot and irr > 600:
            return '6'
     
        if 360 > TES_bot and irr < 600:
            return '5'
        ...
        if 470 > TES_bot:
            ...
            if irr > 600:
                ...
                return '4'
        if irr > 700:
            if TES_bot < self.solar_system.conexion_params['6_T']+40:# - 20:
                return '1'
            ...
            if TES_top > self.solar_system.conexion_params['6_T']:#-20:
                return '3'
            else:
                return '4'
