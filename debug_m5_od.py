"""Mode 5 offdesign test with its own high-temp HX."""
...
for E in [1000, 800, 600]:
    for T_bot in [350, 400, 450, 500]:
        ...
        if ok and sys.network.converged:
            ...
            t10 = sys.conn_10.T.val
            t14 = sys.conn_14.T.val
            Q = sys.ptc_field.Q.val/1e6
            print(f'  E={E} T_bot={T_bot}: OK T02={t02:.0f} T10={t10:.0f} T14={t14:.0f} Q={Q:.2f}MW')
        else:
